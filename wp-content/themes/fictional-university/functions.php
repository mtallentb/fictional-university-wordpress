<?php 
   ...
   function university_styles() {
    ...
    // This action orders custom queries on the archive-{query}.php in ascending order. It also does not show events that have already happened.
    function university_adjust_queries($query) {

        // Make sure you are not viewing from the Dashboard and that the main WordPress query is 'program'.
